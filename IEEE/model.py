...
def train_and_evaluate_models(X_train, y_train, X_val, y_val, X_test, y_test):
    ...
    # XGBoostcreation and ROC-AUC score
    ...
    # CatBoost creation and ROC-AUC score
    ...
    # Random Forest creation and ROC-AUC score
    ...
    # Save the trained models for resue
...
def main():
    ...
    # limit the dataframe to the above
    ...
    y = data['isFraud']
    # To deal with Nans, we will for now use the mean of the column
    imputer = SimpleImputer(strategy='mean')  # Use mean strategy for imputation
    X = imputer.fit_transform(X)

    # Split the data into training and testing sets and a validation set for the neural net
    ...
    # Call the train and eval model to get the saved model
